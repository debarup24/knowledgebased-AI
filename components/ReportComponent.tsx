...
const ReportComponent = ({ onReportConfirmation }: Props) => {
    ...
    function handleReportSelection(event: ChangeEvent<HTMLInputElement>): void {
        ...
        const file = event.target.files[0];  // allowing 1 file only
    ...
    return (
        ...
        <div className="grid w-full items-start gap-6 overflow-auto p-4 pt-0">
            <fieldset className='relative grid gap-6 rounded-lg border p-4'>
                <legend className="text-sm font-medium">PDF file</legend>
                {isLoading && (
                    <div
                ...
                <Textarea
                    ...
                    placeholder="Extracted data from the file will appear here. Get better recommendations by providing additional patient history and symptoms..."
                ...
                <div className='flex flex-row items-center justify-center gap-2 p-4'>
                    <Label>Created by Debarup </Label>
                    <SocialMediaLinks />
                </div>
            </fieldset>
        </div>
